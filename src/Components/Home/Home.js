            ...
            <Container maxWidth="lg">
                <Grid container justify="center">
                    <Grid item xs={12} sm={12} md={12} lg={12}>
                        <div class="caption">
                            <img src={require('../../assets/img/taipei101.png').default} alt='taipei101' />
                            <h1>
                                Welcome to the
                                <span style={{color: '#CEAF89'}}> Purdue </span>  
                                <span style={{color: '#FE0000'}}> Taiwanese </span> 
                                <span style={{color: '#000097'}}> Student </span> 
                                <span style={{color: '#CEAF89'}}> Association</span>
                            </h1>
                            <p>
